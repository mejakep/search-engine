...
def crawl(website, depth = 10): #website = the link you want to start the crawl from, depth = how many pages you want crawl
    ...
    while len(crawled) < depth:
        ...
        if not to_be_crawled[x] in crawled_urls:
            ...
            crawled.append(start) #after all links have been explored, the current site is added to the 
    return (crawled)